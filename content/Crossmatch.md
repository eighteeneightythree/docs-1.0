...
**Minor crossmatch** is the testing of donor serum (or plasma) against recipient red cells. It is not longer routine because of the use of [[Intravenous fluids#pRBC / Packed Red Cells|packed red cells]]. When packed cells are administered only a small fraction of donor antibodies remain and the dilutional effect all but inactivates them.
