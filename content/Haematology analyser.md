...
A red cell count is done by virtually all haematology analysers, even the ancient machines that still perform only a 3-cell differential based on coulters principle (which I am sure are still in use somewhere). If the red count is missing and you want it, ring the lab: the machine certainly calculated it. ^2231fe
