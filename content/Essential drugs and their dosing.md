...
If you want to use a drug and the dose isn't here (or isn't immediately obvious) you should probably get into the room somebody that is more familiar with the drug.
